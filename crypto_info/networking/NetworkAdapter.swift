...
struct NetworkAdapter {
    ...
    static func getProvider() -> MoyaProvider<CryptoAPI> {
        let serverTrustPolicies: [String: ServerTrustPolicy] = [
            "coingecko.com": .disableEvaluation
        ]
        ...
        return MoyaProvider<CryptoAPI>(manager: manager)
    }
    
    static var requests: [Cancellable] = []
    
    static func request(target: CryptoAPI,
